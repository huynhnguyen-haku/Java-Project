...
<html>
    ...
    <body>
        ...
        <section class="jumbotron text-center">
            <div class="container">
                <h1 class="jumbotron-heading"> Trendy is the last stage before tacky </h1>
                <p class="lead text-muted mb-0"> Always dress like you’re going to see your worst enemy </p>
            </div>
        </section>
        <!--Định dạng tiêu đề shop-->
                ...
                <div class="row">
                    <div class="col-md-4 col-lg-3 col-xl-3">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <a href="https://www.facebook.com/myth.azura">Huỳnh Nguyên</a>
                            <li><i class="fa fa-envelope mr-2"></i>nguyehhkse160414@fpt.edu.vn</li>                            
                        </ul>
                    </div>
